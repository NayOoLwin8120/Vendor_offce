              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'You Can Regiester As A Vendor And Welcome',
                      style: TextStyle(
                        fontSize: 16.0,
                    ...
                    Container(
                        ...
                        child:Row(
                          ...
                          children: [
                            Text("Do You Have A Account ",style:TextStyle(fontSize: 18,fontWeight:FontWeight.w400)),
                            InkWell(
                              ...
                              child: Text(
                                "Please Login!",style:TextStyle(fontSize: 19,color: Colors.blue,fontStyle:FontStyle.italic),
                              ),
                            ),
                          ],
                        )
