                    ...
                    Container(
                      width:double.infinity,
                        child:Row(
                          ...
                          children: [
                            Text("Do you have no account? ",style:TextStyle(fontSize: 18,fontWeight:FontWeight.w400)),
                            InkWell(
                              ...
                              child: Text(
                                "Register Now!",style:TextStyle(fontSize: 19,color: Colors.blue,fontStyle:FontStyle.italic),
                              ),
                            ),
                          ],
                        )
